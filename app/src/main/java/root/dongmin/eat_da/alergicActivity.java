...
public class alergicActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alergicMap.put("textView_msgseed", new ArrayList<String>() {{
            add("Buckwheat");
            add("Soybean");
            add("Wheat");
            add("Pine nut");
        }});
        alergicMap.put("textView_msgnut", new ArrayList<String>() {{
            add("Peanut");
            add("Walnut");
        }});
        alergicMap.put("textView_msghardseafood", new ArrayList<String>() {{
            add("Crab");
            add("Shrimp");
        }});
        alergicMap.put("textView_msgseafood", new ArrayList<String>() {{
            add("Squid");
            add("Mackerel");
        }});
        alergicMap.put("textView_msgjoga", new ArrayList<String>() {{ add("Clam"); }});
        alergicMap.put("textView_msgmeat", new ArrayList<String>() {{
            add("Chicken");
            add("Pork");
            add("Beef");
        }});
        alergicMap.put("textView_msgahwang", new ArrayList<String>() {{ add("Sulfites"); }});
        ...
        if (textView != null) {
            textView.setOnClickListener(v -> {
                ...
                if (items != null && !items.isEmpty()) {
                    ...
                    Toast.makeText(getApplicationContext(), "The item does not exist.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public class MiniAlergicAdapter extends RecyclerView.Adapter<MiniAlergicAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            btnComplete.setText(items.size() + " Confirm");
            ...
            holder.itemView.setOnClickListener(v -> {
                ...
                btnComplete.setText(items.size() + " Confirm");  // 남은 개수로 버튼 텍스트 업데이트
            });
        }
